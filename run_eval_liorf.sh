...
echo "🧠 [3/5] Launching LIORF..."
ros2 launch liorf run_mulran.launch.py > $LOG_DIR/liorf.log 2>&1 &
LIO_PID=$!
sleep 5

echo "📦 [4/5] Recording LIORF output to: $EST_BAG_PATH"
ros2 bag record \
  /gt \
